...
| `light` | Apply the bundled Gruvbox Light theme to both appearance modes. |
| `dark` | Apply the bundled Gruvbox Dark theme to both appearance modes. |
...
- `cmux light --help` -> `Usage: cmux light`
- `cmux dark --help` -> `Usage: cmux dark`
