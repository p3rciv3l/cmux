...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "tilingTile", combos: [], description: { en: "Tiling: Master and Stack", ja: "タイリング：マスターとスタック" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingMonocle", combos: [], description: { en: "Tiling: Monocle", ja: "タイリング：モノクル" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingToggleLayout", combos: [], description: { en: "Tiling: Toggle Layout", ja: "タイリング：レイアウトを切り替え" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingFocusNext", combos: [], description: { en: "Tiling: Focus Next Pane", ja: "タイリング：次のペインにフォーカス" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingFocusPrevious", combos: [], description: { en: "Tiling: Focus Previous Pane", ja: "タイリング：前のペインにフォーカス" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingMoveNext", combos: [], description: { en: "Tiling: Move Pane Forward", ja: "タイリング：ペインを次へ移動" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingMovePrevious", combos: [], description: { en: "Tiling: Move Pane Backward", ja: "タイリング：ペインを前へ移動" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingPromote", combos: [], description: { en: "Tiling: Promote Pane to Master", ja: "タイリング：ペインをマスターに移動" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingIncreaseMasterCount", combos: [], description: { en: "Tiling: More Master Panes", ja: "タイリング：マスターペインを増やす" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingDecreaseMasterCount", combos: [], description: { en: "Tiling: Fewer Master Panes", ja: "タイリング：マスターペインを減らす" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingIncreaseMasterRatio", combos: [], description: { en: "Tiling: Widen Master Area", ja: "タイリング：マスター領域を広げる" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingDecreaseMasterRatio", combos: [], description: { en: "Tiling: Narrow Master Area", ja: "タイリング：マスター領域を狭める" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
      { id: "tilingManual", combos: [], description: { en: "Tiling: Manual Layout", ja: "タイリング：手動レイアウト" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
    ],
  },
  {
    id: "browser",
