...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "selectWorkspaceByNumber", combos: [["⌘", "1…9"]], description: { en: "Select workspace 1…9", ja: "ワークスペース1…9を選択" } },
      {
        ...
        combos: [["⌃", "D"]],
        description: { en: "Duplicate selected workspaces", ja: "選択したワークスペースを複製" },
        note: {
          en: "Recreates the layout and resumes terminal Codex conversations. Without a multi-selection, duplicates the active workspace. Overrides terminal Ctrl+D; rebind or unbind duplicateWorkspace in Settings or shortcuts.bindings.",
          ja: "レイアウトを再作成し、ターミナルの Codex 会話を再開します。複数選択がない場合は現在のワークスペースを複製します。ターミナルの Ctrl+D を上書きします。設定または shortcuts.bindings の duplicateWorkspace で変更・解除できます。",
        },
      },
    ...
    shortcuts: [
      {
        ...
        note: { en: "opens a browser surface when a browser is focused", ja: "ブラウザにフォーカス中は新しいブラウザサーフェスを開きます" },
      },
      {
        id: "nextSurface",
        combos: [["⌥", "⌘", "→"]],
        description: { en: "Next surface", ja: "次のサーフェス" },
        note: { en: "when the focused pane has multiple surfaces; otherwise focuses the pane to the right", ja: "フォーカス中のペインに複数のサーフェスがある場合。1つだけの場合は右のペインにフォーカスします" },
      },
      {
        id: "prevSurface",
        combos: [["⌥", "⌘", "←"]],
        description: { en: "Previous surface", ja: "前のサーフェス" },
        note: { en: "when the focused pane has multiple surfaces; otherwise focuses the pane to the left", ja: "フォーカス中のペインに複数のサーフェスがある場合。1つだけの場合は左のペインにフォーカスします" },
      },
  ...
  },
  {
    ...
    titleKey: "splitPanes",
    shortcuts: [
      { id: "focusLeft", combos: [["⌥", "⌘", "←"]], description: { en: "Focus pane left", ja: "左のペインにフォーカス" }, note: { en: "when the focused pane has one surface", ja: "フォーカス中のペインにサーフェスが1つだけの場合" } },
      { id: "focusRight", combos: [["⌥", "⌘", "→"]], description: { en: "Focus pane right", ja: "右のペインにフォーカス" }, note: { en: "when the focused pane has one surface", ja: "フォーカス中のペインにサーフェスが1つだけの場合" } },
      ...
      { id: "moveTabLeft", combos: [["⌘", "⇧", "←"]], description: { en: "Move tab left", ja: "タブを左に移動" } },
      { id: "moveTabRight", combos: [["⌘", "⇧", "→"]], description: { en: "Move tab right", ja: "タブを右に移動" } },
      { id: "moveTabUp", combos: [["⌘", "⇧", "↑"]], description: { en: "Move tab up", ja: "タブを上に移動" } },
      { id: "moveTabDown", combos: [["⌘", "⇧", "↓"]], description: { en: "Move tab down", ja: "タブを下に移動" } },
      ...
      { id: "tilingTile", combos: [["⌃","⌘","T"]], description: { en: "Tiling: Master and Stack", ja: "タイリング：マスターとスタック" } },
      { id: "tilingMonocle", combos: [["⌃","⌘","M"]], description: { en: "Tiling: Monocle", ja: "タイリング：モノクル" } },
      { id: "tilingToggleLayout", combos: [["⌃","⌘","L"]], description: { en: "Tiling: Toggle Layout", ja: "タイリング：レイアウトを切り替え" } },
      { id: "tilingFocusNext", combos: [["⌃","⌘","→"]], description: { en: "Tiling: Focus Next Pane", ja: "タイリング：次のペインにフォーカス" } },
      { id: "tilingFocusPrevious", combos: [["⌃","⌘","←"]], description: { en: "Tiling: Focus Previous Pane", ja: "タイリング：前のペインにフォーカス" } },
      { id: "tilingMoveNext", combos: [["⌃","⇧","⌘","→"]], description: { en: "Tiling: Move Pane Forward", ja: "タイリング：ペインを次へ移動" } },
      { id: "tilingMovePrevious", combos: [["⌃","⇧","⌘","←"]], description: { en: "Tiling: Move Pane Backward", ja: "タイリング：ペインを前へ移動" } },
      { id: "tilingPromote", combos: [["⌃","⌘","↩"]], description: { en: "Tiling: Promote Pane to Master", ja: "タイリング：ペインをマスターに移動" } },
      { id: "tilingIncreaseMasterCount", combos: [["⌃","⌘","↑"]], description: { en: "Tiling: More Master Panes", ja: "タイリング：マスターペインを増やす" } },
      { id: "tilingDecreaseMasterCount", combos: [["⌃","⌘","↓"]], description: { en: "Tiling: Fewer Master Panes", ja: "タイリング：マスターペインを減らす" } },
      { id: "tilingIncreaseMasterRatio", combos: [["⌃","⌥","⌘","→"]], description: { en: "Tiling: Widen Master Area", ja: "タイリング：マスター領域を広げる" } },
      { id: "tilingDecreaseMasterRatio", combos: [["⌃","⌥","⌘","←"]], description: { en: "Tiling: Narrow Master Area", ja: "タイリング：マスター領域を狭める" } },
      { id: "tilingManual", combos: [["⌃","⌘","0"]], description: { en: "Tiling: Manual Layout", ja: "タイリング：手動レイアウト" } },
    ],
  },
  {
    id: "browser",
